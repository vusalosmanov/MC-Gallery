...
import kampaniya from "../assets/images/image/kampaniya.png"
import kampaniya1 from "../assets/images/image/kampaniya1.png"
import kampaniya2 from "../assets/images/image/kampaniya2.png"
const Kampaniyalar = () => {
  return (
            ...
            <div className='lg:w-[100%] '>
                <div className='mb-[17px] lg:flex gap-6 '>
                    <div className='border-4 border-[#ffff] rounded-[14px] shadow-lg '>
                        <img src={kampaniya} alt="kampaniya" className='w-[440px] h-[274px] rounded-[11px]' />
                    </div>
                    <div>
                ...
                <div className='mb-[17px] lg:flex gap-6'>
                    <div className='border-4 border-[#ffff] rounded-[14px] shadow-lg'>
                        <img src={kampaniya1} alt="kanpaniya1" className='w-[440px] h-[274px] rounded-[11px]' />
                    </div>
                    <div>
                ...
                <div className='mb-[17px] lg:flex gap-6'>
                    <div className='border-4 border-[#ffff] rounded-[14px] shadow-lg'>
                        <img src={kampaniya2} alt="kanpaniya2" className='w-[440px] h-[274px] rounded-[11px]' />
                    </div>
                    <div>
